  ...
  return (
    <div className={style.ticket}>
      ...
      <div className={style.ticket__carriage}>
        ...
        <ul className={style.ticket__carriage__list}>
          <li className={style.ticket__carriage__item}>
            ...
            <p className={style.ticket__carriage__item__caption}>Сидячий</p>
          </li>
          ...
          <li className={style.ticket__carriage__item}>
            ...
            <p className={style.ticket__carriage__item__caption}>Плацкарт</p>
          </li>
          ...
          <li className={style.ticket__carriage__item}>
            ...
            <p className={style.ticket__carriage__item__caption}>Купе</p>
          </li>
          ...
          <li className={style.ticket__carriage__item}>
            ...
            <p className={style.ticket__carriage__item__caption}>Люкс</p>
          </li>
        </ul>
      </div>
    </div>
